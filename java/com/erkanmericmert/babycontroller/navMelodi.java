...
public class navMelodi extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nav_melodi);
        ...
        textView = findViewById(R.id.melodiText);
        imageView = findViewById(R.id.imageNoise1);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nav_melodi, menu);
        return true;
    }
    ...
    int sign = 1;
    public void startVoice(View view) throws IOException {
        /*String url = "gs://baby-controller.appspot.com/01-White-Noise-10min.mp3"; // your URL here
